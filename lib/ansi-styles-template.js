...
/**
 * Replace original tags to ANSI escape codes
 * @param {string} str A string to be replaced
 * @param {(Object|undefined)} options_
 * @param {string} [options_.leftBrace]
 * @param {string} [options_.rightBrace]
 * @param {boolean} [options_.strict] Whether to throw an error if an unknown tag matches
 * @return {string}
 */
